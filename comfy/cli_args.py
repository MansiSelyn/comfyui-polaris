...
backend_group.add_argument("--directml", type=int, nargs="?", metavar="DIRECTML_DEVICE", const=-1, help="Use torch-directml (Polaris / DirectML stack; install.bat installs the DIRECTML section into .venv).")
backend_group.add_argument("--zluda", action="store_true", help="Use ZLUDA (CUDA torch on HIP/ROCm; install.bat installs the ZLUDA section into .venv-zluda).")
