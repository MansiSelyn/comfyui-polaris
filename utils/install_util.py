...
# The merged dependency manifest (DirectML and ZLUDA sections; install.bat installs
# each into its own venv).
...
def get_missing_requirements_message():
    ...
    return f"""
Please install the updated requirements by running install.bat
(it creates .venv for the DirectML stack and .venv-zluda for the ZLUDA stack).
